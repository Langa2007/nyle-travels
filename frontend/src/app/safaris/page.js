...
export default function SafariCatalogPage() {
  const {
    tours,
    loading,
    error,
    ...
    <main className="bg-[#fafbfc]">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            Unforgettable <br />
            <span className="italic font-normal text-primary-400">Safaris</span>
          </motion.h1>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-10">
              <div className="flex items-baseline space-x-2">
                ...
                <span className="text-gray-400 font-medium tracking-widest uppercase text-[10px]">Safaris Found</span>
              </div>
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                >
                  {tours.map((tour) => (
                    <TourCard key={tour.id} tour={tour} basePath="/safaris" />
                  ))}
                </motion.div>
              ) : (
                <motion.div 
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif font-bold text-gray-900 mb-2">No matching safaris</h3>
