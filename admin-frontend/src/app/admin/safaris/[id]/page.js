...
export default function SafariEditorPage() {
  ...
  const saveTour = async () => {
    try {
      ...
      alert('Safari saved successfully');
      if (isNew) router.push('/admin/safaris');
    } catch (err) {
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            <h1 className="text-3xl font-serif font-bold text-gray-900">
              {isNew ? 'New Safari' : 'Edit Safari'}
            </h1>
            <p className="text-gray-500 text-sm mt-1">{isNew ? 'Creating a new luxury safari' : formData.name}</p>
          </div>
        </div>
        <Button 
          variant="primary" 
        ...
        {activeTab === 'basic' && (
          ...
          >
            <div className="space-y-6">
              <div>
                <label className="block text-[10px] uppercase tracking-widest font-bold text-gray-400 mb-2 font-bold">Safari Name</label>
                <input 
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-6 pt-4">
                <label className="flex items-center space-x-3 cursor-pointer group">
                  ...
                  />
                  <span className="text-sm font-bold text-gray-600 group-hover:text-primary-500 transition-colors">Featured Safari</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer group">
                  <input 
        ...
        {activeTab === 'content' && (
          ...
          >
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
              <label className="block text-[10px] uppercase tracking-widest font-bold text-gray-400 mb-4">Safari Highlights</label>
